...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('site/images/hero_1.jpg')">
        <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="img-years">
              <img src="{{ asset('site/images/img_1.jpg') }}" alt="Image" class="img-fluid">
              <div class="year">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="nonloop-block-13 owl-carousel d-flex">
              ...
              <div class="item-1 h">
                <img src="{{ asset('site/images/img_2.jpg') }}" alt="Image" class="img-fluid">
                <div class="item-1-contents">
                  <h3>Hair Styling</h3>
                  <ul>
              ...
              <div class="item-1 h">
                <img src="{{ asset('site/images/img_3.jpg') }}" alt="Image" class="img-fluid">
                <div class="item-1-contents">
      ...
      <div class="container">
        ...
        <div class="row hair-style">
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            <a href="#" class="place">
              <img src="{{ asset('site/images/img_1.jpg') }}" alt="Image placeholder">
              <h2>Beard Shaving</h2>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            <a href="#" class="place">
              <img src="{{ asset('site/images/img_2.jpg') }}" alt="Image placeholder">
              <h2>Crew Cut</h2>
              <span>$50.00 only</span>
            </a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6 col-12">
            <a href="#" class="place">
              <img src="{{ asset('site/images/img_3.jpg') }}" alt="Image placeholder">
              <h2>Beard Trim</h2>
              <span>$50.00 only</span>
            </a>
          </div>
    ...
    <div class="site-section section-3" data-stellar-background-ratio="0.5" style="background-image: url('site/images/hero_2.jpg');">
      <div class="container">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              <div class="d-flex v-card align-items-center mb-4">
                <img src="{{ asset('site/images/person_1.jpg') }}" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              <div class="d-flex v-card align-items-center mb-4">
                <img src="{{ asset('site/images/person_2.jpg') }}" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              <div class="d-flex v-card align-items-center mb-4">
                <img src="{{ asset('site/images/person_3.jpg') }}" alt="Image" class="img-fluid mr-3">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{ asset('site/images/img_1.jpg') }}" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{ asset('site/images/img_2.jpg') }}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="{{ asset('site/images/img_3.jpg') }}" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
    ...
    <div class="site-section section-3" data-stellar-background-ratio="0.5" style="background-image: url('site/images/hero_1.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-7 text-center mb-5">
