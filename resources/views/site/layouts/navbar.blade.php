<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-white px-4 px-lg-5"
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
        <i class="fa-solid fa-bars" style="color: #22445e; font-size:1.3rem;"></i>
    </button>
        ...
        <div class="navbar-nav ms-auto py-0 pe-4">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0">
                    ...
                    <a href="{{ route('site.apropos') }}#relations" class="dropdown-item">Relations extérieures</a>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ Route::is('site.domaines') ? 'active' : '' }}"
                    data-bs-toggle="dropdown">Domaines d'Action</a>
                <div class="dropdown-menu m-0">
                    ...
                    <a href="{{ route('site.domaines') }}#cohesions" class="dropdown-item">Cohésion</a>
                    <a href="{{ route('site.domaines') }}#sensibilisations" class="dropdown-item">Sensibilisations</a>
